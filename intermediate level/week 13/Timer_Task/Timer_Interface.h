...
#define TIMER_u16OnPeriod           20
#define Timeru16OffPeriod          40
...
ES_t TIMER_u8GetPWMOnPeriod(u16 *Copy_pu16OnPeriod);
ES_t TIMER_u8GetPWMTotalPeriod(u32 *Copy_pu32TotalPeriod);
ES_t TIMER_u8GetPWMDutyCycle (u8 *Copy_pu8DutyCycle)
